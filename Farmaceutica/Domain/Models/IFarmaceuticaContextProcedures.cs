...
namespace Domain.Models
{
    public partial interface IFarmaceuticaContextProcedures
    {
        ...
        Task<List<sp_MPUsadosResult>> sp_MPUsadosAsync(int? anio, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<List<sp_VentasPorSucursalResult>> sp_VentasPorSucursalAsync(int? anio, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
    }
}
